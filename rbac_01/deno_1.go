...
import (
	...
	"github.com/general252/casbin-demo/rbac_01/casbin_rbac"
)
...
func Rbac01() {
	...
	graphvizImage(s, "hello.gv")
}

func graphvizImage(s *casbin_rbac.CasbinServer, outfile string) {
	dots, err := s.GetDots(dataSource)
	if err != nil {
		return
	}
